...
; Exercício 5
; Lista -> Booleano
; Função que veririca se uma lista é um palíndromo
...
; Exercício 9
; Lista -> Numero
; Função que recebe uma lista e devolve o maior termo
(define (maior_numero lst)
  (cond [(empty? (rest lst)) (first lst)]
        [else (max (first lst) (maior_numero (rest lst)))]))
